...
Private Declare Function MoveToEx Lib "gdi32" (ByVal hdc As Long, ByVal x As Long, ByVal y As Long, lpPoint As pointapi2) As Long
...
Private Declare Function GetCursorPos Lib "user32" (lpPoint As pointapi2) As Long
...
Private rc As RECT, rc2 As RECT, rc3 As RECT, fc As pointapi2 'text and focus rect locations
Private picPT As pointapi2, picSZ As pointapi2  'picture Position & Size
